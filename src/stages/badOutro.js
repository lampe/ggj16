BadOutro = function () {
  this.preload = function () {
    ...
    game.load.image('outro2', 'assets/outro/outro_2_lose.png');
  ...
  this.create = function () {
    ...
    BadOutro.textbox = this.textbox;
    this.oldImg = this.currentImg;
    this.currentImg = game.add.sprite(0, 0, 'outro1a');
    BadOutro.currentImg2 = game.add.sprite(0, 0, 'outro1b');
    var d1 = {
      text: [''],
      cb: function () {
        content = d2.text;
        contentCb = d2.cb;
        BadOutro.currentImg2.destroy();
        this.oldImg = this.currentImg;
    ...
    var d2 = {
      text: ["This is disgusting!", "But I’ll come back tomorrow anyway."],
      cb: function () {
        content = d3.text;
        contentCb = d3.cb;
        this.oldImg = this.currentImg;
...
function nextLineBadOutro() {
  ...
  game.time.events.repeat(wordDelay, line.length, nextWordBadOutro, this);
...
function nextWordBadOutro() {
  BadOutro.textbox.bringToTop();
  text.bringToTop();
  ...
  if (wordIndex === line.length) {
    ...
    game.time.events.add(lineDelay, nextLineBadOutro, this);
  }
